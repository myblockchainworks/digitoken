...
<html lang="en">
<head>
<title>Digi Token - Register</title>
<meta charset="utf-8">
...
<body>
        <!--sign up page-->
	<a href="index"><h1 style="color:#d7ac25;margin-left: 120px;text-align: center;margin-top: 50px;margin-bottom: 50px;">Digi Token Wallet</h1></a>
