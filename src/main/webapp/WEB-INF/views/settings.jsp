...
<script src="<c:url value="/resources/js/digi.js" />"></script>
...
<div id="wrapper">
    ...
    <div class="headermain">
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="col-lg-6">
                <div class="col-xs-12"><h2 style="color:#d7ac25;">Digi Token Wallet</h2></div>
            ...
            <div class="sidebar-collapse menubar">
                <ul class="nav ">
                    ...
                    <li>
              		...
              		<li>
                        <a href="buytoken">Buy Digi</a>
                    </li>
                    <li>
                        <a href="sendtoken">Send Digi</a>
                    </li>
                    <li class="active">
            ...
            <div class="panel panel-default" style="height:600px;">
                ...
                <div class="panel-body">
	                ...
	                <div style="padding: 10px">
						...
						<div class="form-inline">
							<label for="name" style="width: 250px;"><span>Network</span></label> <span>:</span> <label for="name" style="font-weight: normal;">
								<span>Kovan Testnet</span></label>
						</div>
